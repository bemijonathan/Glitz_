		...
		<header className="text-gray-500 body-font fixed w-full __header z-10">
			<div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center  hidden md:flex">
				...
				<nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
					<a className="mr-5 cursor-pointer text-white" href="#about">
						About
					</a>
					<a className="mr-5 cursor-pointer text-white" href="#schedule">
						Schedule
					</a>
					<a className="mr-5 cursor-pointer text-white" href="#training">
						Training
					</a>
					<a className="mr-5 cursor-pointer text-white" href="#register">
						Register
					</a>
				</nav>
				<button
